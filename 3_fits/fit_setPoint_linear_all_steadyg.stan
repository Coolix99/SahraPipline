...
transformed parameters {
    ...
    real g_0_Dev =
        beta_ * (A_end - A_0_Dev) / A_end;

    real g_0_smoc_dev =
        beta_ * (A_end_smocdev - A_0_smoc_dev) / A_end_smocdev;
}
...
model {
    ...
    Ahat_Reg =
        to_vector(A_theor_t0(t_Reg, 47.999, A_0_Reg, 0, alpha, beta_, A_end));

    Ahat_4850cut =
        to_vector(A_theor_t0(t_4850cut, 47.999, A_0_4850cut, 0, alpha, beta_, A_end));
