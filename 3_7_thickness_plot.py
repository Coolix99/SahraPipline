...
def main():
    ...
    for EDcells_folder in EDcells_folder_list:
        ...
        print(MetaData_EDcell_props['MetaData_EDcell_props'])
        if MetaData_EDcell_props['MetaData_EDcell_props']['condition'] != 'Regeneration':
            continue
        if MetaData_EDcell_props['MetaData_EDcell_props']['time in hpf'] != 48:
            continue
        ...
        get_thickness_cellLayers(mesh,EDcells_img,scales_zyx)
